...
class ReportIlluminance extends connect(store)(localize(i18next)(PageView)) {
  ...
  render() {
    return html`
      ...
      <div main>
        <div header>
          <label><a href="fms-report">Report</a> > Illuminance</label>
    ...
    this.config = {
      ...
      columns: [
        ...
        },
        {
          type: 'number',
          name: 'value',
          header: i18next.t('field.value') + '(nm)',
          record: { editable: false, align: 'right' },
          imex: { header: i18next.t('field.value') + '(nm)', key: 'value', width: 50, type: 'number' },
          sortable: true,
          width: 150
        },
        {
...
window.customElements.define('report-illuminance', ReportIlluminance)

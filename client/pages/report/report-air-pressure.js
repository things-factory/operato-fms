...
class ReportAirPressure extends connect(store)(localize(i18next)(PageView)) {
    ...
    this.config = {
      ...
      columns: [
        ...
        },
        {
          type: 'number',
          name: 'value',
          header: i18next.t('field.value') + '(hPa)',
          record: { editable: false, align: 'right' },
          imex: { header: i18next.t('field.value') + '(hPa)', key: 'value', width: 50, type: 'number' },
          sortable: true,
          width: 150
        },
        {
...
window.customElements.define('report-air-pressure', ReportAirPressure)
